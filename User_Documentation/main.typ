...
#indent[== Using the Camera
To log a meal, you should take a picture of it:

1. Tap the #button[+] in the right bottom corner of the page.
...
- *Analysis:* we also give you a general *Quality Score* that measures how healthy your meal is, as well as a *Goal Fit* score and a *Calorie Density Measure*, which are estimated by AI.
...
#table(
  ...
  align: center,
  [
    #image("insights_graph.png", width: 45%)
  ],
  [
    #image("insights_buttons.png", width: 45%)
  ]
) ]
...
#indent[=== Current Streak and Max Meal
...
#table(
  ...
  align: center,
  [
    #image("nutrition_goal_button.png", width: 45%)
  ],
  [
    #image("nutrition_page.png", width: 45%)
  ]
)
...
In case the connection to the server is not possible, our app allows you to navigate it on Offline Mode. In this mode, you can still see part of your history. To see if you are on Offline Mode, you can check the top right corner or the bottom of your screen. 
...
#table(
  ...
  align: center,
  [
    #image("offline_mode_1.png", width: 45%)
  ],
  [
    #image("offline_mode_2.png", width: 45%)
  ]
)
