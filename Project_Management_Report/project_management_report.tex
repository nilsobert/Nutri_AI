...
\label{chap:sys}
- Design Pattern: from the coarse to the more granular design (participants in the system, data flows, etc.)
- collected requirements

\subsection{Database Design}
\label{chap:db}
- collected requirements (Design Pattern s.o.) -> coarse description of potential data classes
- prototype: JSON, evolution to -> SQLite, because of...
