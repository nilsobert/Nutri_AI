...
- Specified Output format specifically (JSON)
- Provieded Examples for the desired output (Meal with Nutriant Facts) to give more context to the model (wtihin prompt)
- Provided some rules to the model for deterministic results
- prompt: "Analyze the attached meal image and provide a detailed nutritional breakdown. Identify each distinct food item, estimate its weight in grams, and list its core nutritional facts
- Make table with the rules: RULES:
