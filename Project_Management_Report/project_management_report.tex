...
\\
Finally, a comprehensive VLM evaluation against our ground truth meal dataset, further elaborated in Section \ref{chap:eval}, revealed that among all tested models, \texttt{qwen3-vl-235b-a22b-instruct} was the most precise in nutrient estimation, serving as our current production-ready model.
...
\begin{itemize}
    ...
    \item \textbf{Transcription Accuracy}: The locally hosted Whisper model is currently limited by its size. Upgrading to a larger, more robust architecture would improve transcription precision, particularly in handling diverse accents and background noise.
