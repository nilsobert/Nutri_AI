...
\begin{axis}[
    ...
    ylabel={Overall MAE (\%)},
    xlabel={App},
    symbolic x coords={NutriAI: Photo + Audio Input, NutriAI: Photo Input only, CalorixAI, CalorieCueAI, arise},
    xtick=data,
    ...
    title={Overall Mean Absolute Percentage Error by App},
...
\addplot[
    ...
    (NutriAI: Photo + Audio Input, 45.18)
    (NutriAI: Photo Input only, 52.24)
    (CalorixAI, 58.74)
    (CalorieCueAI, 66.60)
    (arise, 81.32)
};
...
\begin{axis}[
    ...
    grid=major,
    grid style={dashed, gray!30},
    title={Percentage Error Distribution by App (All Nutrients + Calories)},
    legend style={at={(1.02,1)}, anchor=north west, font=\small},
    cycle list={
        {fill=blue!30, draw=blue!70},
        {fill=red!30, draw=red!70},
        {fill=green!30, draw=green!70},
        {fill=orange!30, draw=orange!70}
    },
]

% Add a reference line at y=0
\addplot[gray, dashed, thick, forget plot] coordinates {(0.5,0) (5.5,0)};

% Calorie Cue AI - position 1
\addplot+[boxplot prepared={
    lower whisker=-51.82,
    lower quartile=-5.39,
    median=27.31,
    upper quartile=54.05,
    upper whisker=204.82
}, ] coordinates {};
...
\addplot+[boxplot prepared={
    ...
    lower quartile=0.78,
    median=19.55,
    upper quartile=70.21,
    upper whisker=195.52
}, ] coordinates {};
...
\addplot+[boxplot prepared={
    ...
    lower quartile=-8.74,
    median=13.81,
    upper quartile=35.35,
    upper whisker=328.57
}, ] coordinates {};
...
\addplot+[boxplot prepared={
    ...
    lower quartile=1.92,
    median=55.00,
    upper quartile=82.29,
    upper whisker=383.33
}, ] coordinates {};

% Calorix AI - position 2
\addplot+[boxplot prepared={
    lower whisker=-25.74,
    lower quartile=-13.22,
    median=24.64,
    upper quartile=35.66,
    upper whisker=100.00
}, ] coordinates {};

\addplot+[boxplot prepared={
    lower whisker=-42.25,
    lower quartile=-15.11,
    median=-1.16,
    upper quartile=4.69,
    upper whisker=203.23
}, ] coordinates {};

\addplot+[boxplot prepared={
    lower whisker=-60.87,
    lower quartile=-18.85,
    median=-2.63,
    upper quartile=21.88,
    upper whisker=285.71
}, ] coordinates {};

\addplot+[boxplot prepared={
    lower whisker=-36.36,
    lower quartile=35.53,
    median=62.39,
    upper quartile=189.58,
    upper whisker=260.00
}, ] coordinates {};

% Nutri AI-Photo input only - position 3
\addplot+[boxplot prepared={
    lower whisker=-52.76,
    lower quartile=-16.61,
    median=4.75,
    upper quartile=30.44,
    upper whisker=136.62
}, ] coordinates {};

\addplot+[boxplot prepared={
    lower whisker=-100.00,
    lower quartile=-10.69,
    median=37.70,
    upper quartile=59.00,
    upper whisker=248.39
}, ] coordinates {};

\addplot+[boxplot prepared={
    lower whisker=-65.22,
    lower quartile=-14.29,
    median=-9.58,
    upper quartile=52.08,
    upper whisker=111.76
}, ] coordinates {};

\addplot+[boxplot prepared={
    lower whisker=-66.67,
    lower quartile=-32.78,
    median=20.51,
    upper quartile=43.86,
    upper whisker=125.00
}, ] coordinates {};

% NutriAI-Photo+ Audio Input - position 4
\addplot+[boxplot prepared={
    lower whisker=-37.29,
    lower quartile=0.00,
    median=6.27,
    upper quartile=34.94,
    upper whisker=154.39
}, ] coordinates {};
...
\addplot+[boxplot prepared={
    ...
    lower quartile=7.26,
    median=34.61,
    upper quartile=39.99,
    upper whisker=141.94
}, ] coordinates {};
...
\addplot+[boxplot prepared={
    ...
    lower quartile=-5.00,
    median=2.94,
    upper quartile=28.12,
    upper whisker=128.57
}, ] coordinates {};

\addplot+[boxplot prepared={
    lower whisker=-66.67,
    lower quartile=-11.84,
    median=10.00,
    upper quartile=51.28,
    upper whisker=266.67
}, ] coordinates {};
...
\addplot+[boxplot prepared={
    ...
    lower quartile=7.33,
    median=44.33,
    upper quartile=64.33,
    upper whisker=154.82
}, ] coordinates {};
...
\addplot+[boxplot prepared={
    ...
    lower quartile=-2.79,
    median=9.33,
    upper quartile=36.98,
    upper whisker=183.87
}, ] coordinates {};

\addplot+[boxplot prepared={
    lower whisker=-36.84,
    lower quartile=24.46,
    median=36.67,
    upper quartile=65.08,
    upper whisker=342.86
}, ] coordinates {};

\addplot+[boxplot prepared={
    lower whisker=-36.36,
    lower quartile=38.89,
    median=107.05,
    upper quartile=207.29,
    upper whisker=540.00 
}, ] coordinates {};

% Legend
\legend{Calories, Carbs, Proteins, Fats}
