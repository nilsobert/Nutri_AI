...
During development, we applied prompt engineering techniques for our main logging feature as well as for the recipe suggestion feature. The following section, however, focuses on our service's main feature, meal logging, since similar methods were employed for both features.
To evaluate the performance of different prompts, we compared two distinct prompt sets (system and user prompts) - a simpler and a more complex one.
